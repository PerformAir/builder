...
# Install maven
# Ref: https://github.com/carlossg/docker-maven
...
# Install docker ce
RUN curl -sSL -o /tmp/docker.tgz https://download.docker.com/linux/static/stable/x86_64/docker-19.03.8.tgz \
    && tar -xzf /tmp/docker.tgz -C /tmp \
    && cp /tmp/docker/* /usr/bin \
    && rm -rf /tmp/docker*

# Eventually when all combined...
